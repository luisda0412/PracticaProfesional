...
--Estuches 1
INSERT INTO Articulo VALUES('Estuche Iphone XR', 10000, (SELECT * FROM OPENROWSET(BULK N'C:\estuche1.png', SINGLE_BLOB) as T1), 1,1, 5, 1)
...
INSERT INTO Articulo VALUES('Audifonos Pro 8', 18000, (SELECT * FROM OPENROWSET(BULK N'C:\audifonos2.jpg', SINGLE_BLOB) as T1), 5,3, 4, 1)
INSERT INTO Articulo VALUES('Audifonos SOMOSTEL SMS-J13', 20000, (SELECT * FROM OPENROWSET(BULK N'C:\audifonos3.jpg', SINGLE_BLOB) as T1), 5,3, 4, 1)
INSERT INTO Articulo VALUES('Audifonos m10', 35000, (SELECT * FROM OPENROWSET(BULK N'C:\audifonos4.jpg', SINGLE_BLOB) as T1), 5,3, 4, 1)
...
INSERT INTO Articulo VALUES('Audifonos SOMOSTEL', 20000, (SELECT * FROM OPENROWSET(BULK N'C:\audifonos6.jpg', SINGLE_BLOB) as T1), 5,3, 4, 1)
